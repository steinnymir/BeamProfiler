...
import cv2
from legacy.BeamProfilerLib.BeamProfilerUI import Ui_MainWindow
from legacy.BeamProfilerLib import get_frame, get_devicelist
from legacy.BeamProfilerLib.utils import io
import time
import numpy as np
...
def main():
    ...
    sys.excepthook = io.my_exception_hook
...
class BeamProfilerMainApp(qw.QMainWindow, Ui_MainWindow):
    ...
    def select_device(self):
        ...
        utils.print_dict(self.devicedict)
    ...
    def save_screenshot(self):
        ...
        filename = utils.choose_save_filename(initialdir='c://')
        utils.save_obj(saveframe, filename)
